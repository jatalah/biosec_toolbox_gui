...
```{r}
#| layout-ncol: 1
div(style = "height: 90vh;", plotOutput("plots"))
...
library(cowplot)  # Add cowplot library

node_status_plots1 <- read_rds("node_status_plots.rds")
industry_plots1 <- read_rds("industry_plots.rds")
